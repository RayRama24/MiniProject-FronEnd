...
const DashboardAdmin = () => {
  ...
  return (
    <div className="dashboardAdmin">
      <AddProductModal show={show} handleClose={handleClose} setRefresh={setRefresh} refresh={refresh} />
      <EditProductModal showEdit={showEdit} handleCloseEdit={handleCloseEdit} setRefresh={setRefresh} refresh={refresh} dataEditProduct={dataEditProduct} />
            ...
            {dataProducts.map((product) => (
              <tr>
                ...
                <td>
                  ...
                  <Button variant="danger" className="mx-1" onClick={() => deleteProductById(product.id)}>
                    Delete
                  </Button>
                </td>
              </tr>
